...
{   
    ...
    arma::vec frequency_list = arma::linspace(0.2,2.5,100);
    //Definin amplitude values 
    arma::vec amplitude_list = {0.1,0.4,0.7};
    ...
    {   
        ...
        std::string path_str = "./Data/RK4_perturbation_"+std::to_string(n_particles)+"_" + std::to_string(N) +"_" + inter+std::to_string(amplitude_list.at(f_i)) +".txt";
