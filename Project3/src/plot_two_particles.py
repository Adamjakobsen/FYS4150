...
plt.scatter(x_particle2[0],y_particle2[0],c="r")
plt.scatter(x_particle1[0],y_particle1[0],c="r",label="Initial position")
plt.scatter(x_particle2[-1],y_particle2[-1],c="g")
plt.scatter(x_particle1[-1],y_particle1[-1],c="g",label="End position")
plt.xlabel(r"x [$\mu$m]")
plt.ylabel(r"y [$\mu$m]")
plt.legend()
