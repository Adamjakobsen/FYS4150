...
void monte_carlo(int L, int mc_cycles, int burn_pct, double T, int align)
{
    ...
    std::string filename = "cfg_L" + std::to_string(L) + "_mc_" + std::to_string(mc_cycles) + "_burn_" + std::to_string(burn_pct) + "_t_" + std::to_string(int(T)) + ".txt";
    std::string filename2 = "qt_L" + std::to_string(L) + "_mc_" + std::to_string(mc_cycles) + "_burn_" + std::to_string(burn_pct) + "_t_" + std::to_string(int(T)) + ".txt";
